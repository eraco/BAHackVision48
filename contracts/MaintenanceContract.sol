...
contract MaintenanceContract {
    ...
    function bookUsedHours(uint deviceId, uint hoursUsed) public returns (uint) {
    ...
    function getHoursSinceLastInspectionById(uint deviceId) public returns (uint) {
        uint  hrs = devices[deviceId].hoursSinceLastInspection;
        return hrs;
    }
